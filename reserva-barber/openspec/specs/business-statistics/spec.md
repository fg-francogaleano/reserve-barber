...
The owner's measurement of their business over a period they choose: five figures and a closed set of preset ranges. Every figure is bounded by the same instant range on the appointment's own `startTime`, because the page divides one figure by another and a quotient whose numerator and denominator cover different populations means nothing. That is also why this capability's income figure and `dashboard-home`'s will not agree, and why both are required to state their basis.
