...
export type BookingWhereInput = {
  ...
  priceAtBooking?: Prisma.DecimalFilter<"Booking"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  depositAmount?: Prisma.DecimalFilter<"Booking"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  cancellationToken?: Prisma.StringFilter<"Booking"> | string
...
export type BookingScalarWhereWithAggregatesInput = {
  ...
  priceAtBooking?: Prisma.DecimalWithAggregatesFilter<"Booking"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  depositAmount?: Prisma.DecimalWithAggregatesFilter<"Booking"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  cancellationToken?: Prisma.StringWithAggregatesFilter<"Booking"> | string
...
export type $BookingPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  objects: {
    ...
    /**
     * A list, not a single payment: a rejected attempt does not block a retry,
     * so a booking can accumulate several. At most one of them is ever live,
     * which is a partial unique index on Payment rather than a rule here.
     */
  ...
  scalars: runtime.Types.Extensions.GetPayloadResult<{
    ...
    cancelledBy: $Enums.CancelledBy | null
    /**
     * When the email provider accepted the confirmation message (N1).
     * 
     * **This is not an idempotency key and nothing reads it before sending.**
     * At-most-once delivery is already a property of the confirming transition:
     * both writers update this row conditionally on the status they expect, so
     * exactly one caller per booking ever observes the confirming outcome. A
     * second mechanism claiming the same guarantee would be a second thing to
     * get wrong, and a read-then-send would reintroduce the race the guarded
     * update exists to avoid.
     * 
     * What it buys is a question the product otherwise cannot ask: **a null on a
     * CONFIRMED booking means that client was never told their appointment is
     ...
     * dashboard aggregates were indexed by measurement rather than assumption
...
export interface BookingFieldRefs {
  ...
  readonly priceAtBooking: Prisma.FieldRef<"Booking", 'Decimal'>
  readonly depositAmount: Prisma.FieldRef<"Booking", 'Decimal'>
  readonly cancellationToken: Prisma.FieldRef<"Booking", 'String'>
